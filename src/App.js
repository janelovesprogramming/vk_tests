...
import extr from '../src/api/extr.png';
			...
			tasks: [
				{
					...
					text: 'Большая пятерка – психологическая модель, описывающая структуру личности человека посредством пяти общих, относительно независимых черт:  «нейротизм» ,«экстраверсия» , «открытость опыту» , «сдоброжелательность» , «добросовестность»',
					image_back: peo
				...
				},
				{
					...
					text: 'Большая пятрека – психологическая модель, описывающая структуру личности человека посредством пяти общих, относительно независимых черт: «нейротизм» ,«экстраверсия» , «открытость опыту» , «сдоброжелательность» , «добросовестность»',
					image_back: people
				}
			...
			if (this.state.big5mas[k] > 51) {
				switch (k) {
					case 0:
						return (
							<div>
								...
								<div style={divStyle}>
									<br>Характерные черты:</br> общительность, поиск впечатлений, доминирование, активность
					...
					case 3:
						return (
							<div>
								<h2>Эмоциональная неустойчивость</h2>
								<div style={divStyle}>
			...
			else if (this.state.big5mas[k] < 40)
			{
				switch (k) {
					...
					case 3:
						return (
							<div>
								<h2>Эмоциональная устойчивость</h2>
								<div style={divStyle}>
