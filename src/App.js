			...
			tasks: [
				{
					...
					text: 'Личность – это несложное понятие, ясное для большинства из нас. Это то, что делает нас «нами», охватывает всю совокупность черт, характеристик и причуд, выделяющих нас из всех остальных. Льюис Голдберг, вероятно, самый известный исследователь в области психологии личности, разработал пятифакторный тест, получивший, в дальнейшем, повсеместное распространение и научную аккридитацию.\n' +
						'Пройдя этот тест, вы определите свои показатели по шкале big5 и узнаете о себе много нового!',
					image_back: peo
				}
