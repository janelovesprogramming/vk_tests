			...
			tasks: [
				{
					...
					text: 'Личность – это несложное понятие, ясное для большинства из нас. Это то, что делает нас «нами», охватывает всю совокупность черт, выделяющих нас из всех остальных. Льюис Голдберг, вероятно, самый известный исследователь в области психологии личности, разработал пятифакторный тест, получивший, повсеместное распространение и научную аккридитацию.\n' +
