	...
	constructor(props) {
		...
		this.state = {
			tasks: [
				{
					id: 1,
					name: 'Пятифакторный опросник личности 5PFQ (10 вопросов)',
					text: 'Пятифакторная модель личности – психологическая модель, описывающая структуру личности человека посредством пяти общих, относительно независимых черт:\n' +
						'«нейротизм», ' +
						'«экстраверсия» ,' +
						'«открытость опыту» ,' +
						'«доброжелательность» ,' +
				...
				{
					id: 2,
					name: 'Пятифакторный опросник личности 5PFQ (75 вопросов)',
					text: 'Пятифакторная модель личности – психологическая модель, описывающая структуру личности человека посредством пяти общих, относительно независимых черт:\n' +
						'«нейротизм» ,' +
						'«экстраверсия» ,' +
						'«открытость опыту» ,' +
